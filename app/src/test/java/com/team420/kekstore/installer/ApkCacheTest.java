...
public class ApkCacheTest {
    ...
    public void testGetApkDownloadPath() {
        assertEquals("Should be in folder based on repo hostname",
                new File(cacheDir, "f-droid.org--1/com.team420.kekstore_1008000.apk"),
                ApkCache.getApkDownloadPath(context,
                        "https://f-droid.org/repo/com.team420.kekstore_1008000.apk"));
        ...
        assertEquals("Should work for OTA files also",
                new File(cacheDir, "f-droid.org--1/com.team420.kekstore.privileged.ota_2110.zip"),
                ApkCache.getApkDownloadPath(context,
                        "http://f-droid.com.team420/repo/com.team420.kekstore.privileged.ota_2110.zip"));
