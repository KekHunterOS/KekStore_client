...
import static com.team420.kekstore.Assert.assertContainsOnly;
import static com.team420.kekstore.Assert.assertResultCount;
import static com.team420.kekstore.Assert.insertApk;
...
public class AppProviderTest extends FDroidProviderTest {
    ...
    public void testInsert() {
        ...
        // Insert a new record...
        insertApp("com.team420.kekstore", "F-Droid");
        cursor = queryAllApps();
        assertNotNull(cursor);
        ...
        cursor.close();
        assertEquals("com.team420.kekstore", app.packageName);
        assertEquals("F-Droid", app.name);

        App otherApp = AppProvider.Helper.findSpecificApp(context.getContentResolver(), "com.team420.kekstore", 1, Cols.ALL);
        assertNotNull(otherApp);
        assertEquals("com.team420.kekstore", otherApp.packageName);
    ...
    public void testInsertTrimsNamesAndSummary() {
        ...
        App app = insertApp("com.team420.trimmer", "Trim me\n", "Trim me too\n");

        assertEquals("com.team420.trimmer", app.packageName);
