...
import com.team420.kekstore.mock.RepoDetails;
...
public class RepoXMLHandlerTest {
    ...
    public void testPushRequestsRepoCorruption() {
        ...
        repoPushRequest = new RepoPushRequest("install", "com.team420.kekstore", "999999999999");
        assertEquals(repoPushRequest.versionCode, null);

        repoPushRequest = new RepoPushRequest("install", "com.team420.kekstore",
        ...
        repoPushRequest = new RepoPushRequest("Robert'); DROP TABLE Students; --", "com.team420.kekstore", null);
        assertEquals(repoPushRequest.request, null);
        assertEquals(repoPushRequest.packageName, "com.team420.kekstore");
        assertEquals(repoPushRequest.versionCode, null);
    ...
    public void testLargeRepo() {
        ...
        expectedAntiFeatures.put("com.team420.kekstore", new ArrayList<String>());
        ...
        checkIncludedApps(actualDetails.apps, new String[]{
                ...
                "com.google.marvin.shell", "com.team420.kekstore",
    ...
    private void checkPushRequests(RepoDetails actualDetails) {
        final Object[] expectedPushRequestsIndex = new Object[]{
                "install", "com.team420.kekstore", 101002,
                "install", "com.team420.kekstore.privileged", null,
        ...
        checkIncludedApps(actualDetails.apps, new String[]{
                "com.team420.kekstore", "com.team420.kekstore.privileged",
        });
