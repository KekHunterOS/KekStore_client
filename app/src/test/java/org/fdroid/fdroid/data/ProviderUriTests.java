...
import static org.fdroid.kekstore.Assert.assertInvalidUri;
import static org.fdroid.kekstore.Assert.assertValidUri;
...
public class ProviderUriTests {
    ...
    public void validAppProviderUris() {
        ...
        App app = new App();
        app.repoId = 1;
        app.packageName = "org.fdroid.kekstore";

        assertValidUri(resolver, AppProvider.getSpecificAppUri(app.packageName, app.repoId),
                APP_PROVIDER_URI_BASE + "/app/1/org.fdroid.kekstore", projection);
    }
    ...
    public void validTempAppProviderUris() {
        ...
        packageNames.add("org.fdroid.kekstore");
        packageNames.add("com.example.com");

        assertValidUri(resolver, TempAppProvider.getAppsUri(packageNames, 1),
                TEMP_APP_PROVIDER_URI_BASE + "/apps/1/org.fdroid.kekstore%2Ccom.example.com", projection);
    ...
    public void validApkProviderUris() {
        ...
        assertValidUri(resolver, ApkProvider.getAppUri("org.fdroid.kekstore"),
                APK_PROVIDER_URI_BASE + "/app/org.fdroid.kekstore", projection);
        assertValidUri(resolver, ApkProvider.getApkFromAnyRepoUri(new MockApk("org.fdroid.kekstore", 100)),
                APK_PROVIDER_URI_BASE + "/apk-any-repo/100/org.fdroid.kekstore", projection);
        assertValidUri(resolver, ApkProvider.getApkFromAnyRepoUri("org.fdroid.kekstore", 100, null),
                APK_PROVIDER_URI_BASE + "/apk-any-repo/100/org.fdroid.kekstore", projection);
