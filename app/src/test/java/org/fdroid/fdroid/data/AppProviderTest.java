...
import static org.fdroid.kekstore.Assert.assertContainsOnly;
import static org.fdroid.kekstore.Assert.assertResultCount;
import static org.fdroid.kekstore.Assert.insertApk;
...
public class AppProviderTest extends FDroidProviderTest {
    ...
    public void testInsert() {
        ...
        // Insert a new record...
        insertApp("org.fdroid.kekstore", "F-Droid");
        cursor = queryAllApps();
        assertNotNull(cursor);
        ...
        cursor.close();
        assertEquals("org.fdroid.kekstore", app.packageName);
        assertEquals("F-Droid", app.name);

        App otherApp = AppProvider.Helper.findSpecificApp(context.getContentResolver(), "org.fdroid.kekstore", 1, Cols.ALL);
        assertNotNull(otherApp);
        assertEquals("org.fdroid.kekstore", otherApp.packageName);
