...
import org.fdroid.kekstore.mock.RepoDetails;
...
public class RepoXMLHandlerTest {
    ...
    public void testPushRequestsRepoCorruption() {
        ...
        repoPushRequest = new RepoPushRequest("install", "org.fdroid.kekstore", "999999999999");
        assertEquals(repoPushRequest.versionCode, null);

        repoPushRequest = new RepoPushRequest("install", "org.fdroid.kekstore",
        ...
        repoPushRequest = new RepoPushRequest("Robert'); DROP TABLE Students; --", "org.fdroid.kekstore", null);
        assertEquals(repoPushRequest.request, null);
        assertEquals(repoPushRequest.packageName, "org.fdroid.kekstore");
        assertEquals(repoPushRequest.versionCode, null);
    ...
    public void testLargeRepo() {
        ...
        expectedAntiFeatures.put("org.fdroid.kekstore", new ArrayList<String>());
        ...
        checkIncludedApps(actualDetails.apps, new String[]{
                ...
                "com.google.marvin.shell", "org.fdroid.kekstore",
    ...
    private void checkPushRequests(RepoDetails actualDetails) {
        final Object[] expectedPushRequestsIndex = new Object[]{
                "install", "org.fdroid.kekstore", 101002,
                "install", "org.fdroid.kekstore.privileged", null,
        ...
        checkIncludedApps(actualDetails.apps, new String[]{
                "org.fdroid.kekstore", "org.fdroid.kekstore.privileged",
        });
