...
public class InstalledAppProviderService extends JobIntentService {
    ...
    private static final String ACTION_INSERT = "org.fdroid.kekstore.data.action.INSERT";
    private static final String ACTION_DELETE = "org.fdroid.kekstore.data.action.DELETE";

    private static final String EXTRA_PACKAGE_INFO = "org.fdroid.kekstore.data.extra.PACKAGE_INFO";
