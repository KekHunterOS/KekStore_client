...
import org.fdroid.kekstore.data.Schema.ApkAntiFeatureJoinTable;
import org.fdroid.kekstore.data.Schema.ApkTable;
import org.fdroid.kekstore.data.Schema.AppMetadataTable;
import org.fdroid.kekstore.data.Schema.AppMetadataTable.Cols;
import org.fdroid.kekstore.data.Schema.AppPrefsTable;
import org.fdroid.kekstore.data.Schema.CatJoinTable;
import org.fdroid.kekstore.data.Schema.CategoryTable;
import org.fdroid.kekstore.data.Schema.InstalledAppTable;
import org.fdroid.kekstore.data.Schema.PackageTable;
...
/**
 * Each app has a bunch of metadata that it associates with a package name (such as org.fdroid.kekstore).
...
public class AppProvider extends FDroidProvider {
     ...
     * {@link org.fdroid.kekstore.data.QuerySelection#add(QuerySelection)} and
     * {@link org.fdroid.kekstore.data.QuerySelection#add(String, String[])} methods
     * will only return the base class {@link org.fdroid.kekstore.data.QuerySelection}
     * which is not aware of the installed app table.
     * However, the
     * {@link org.fdroid.kekstore.data.AppProvider.AppQuerySelection#add(org.fdroid.kekstore.data.AppProvider.AppQuerySelection)}
