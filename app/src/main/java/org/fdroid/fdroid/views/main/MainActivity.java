...
package org.fdroid.kekstore.views.main;
...
import org.fdroid.kekstore.AppUpdateStatusManager;
import org.fdroid.kekstore.AppUpdateStatusManager.AppUpdateStatus;
import org.fdroid.kekstore.BuildConfig;
import org.fdroid.kekstore.FDroidApp;
import org.fdroid.kekstore.NfcHelper;
import org.fdroid.kekstore.Preferences;
import org.fdroid.kekstore.R;
import org.fdroid.kekstore.UpdateService;
import org.fdroid.kekstore.Utils;
import org.fdroid.kekstore.data.NewRepoConfig;
import org.fdroid.kekstore.localrepo.SDCardScannerService;
import org.fdroid.kekstore.net.WifiStateChangeService;
import org.fdroid.kekstore.views.AppDetailsActivity;
import org.fdroid.kekstore.views.ManageReposActivity;
import org.fdroid.kekstore.views.apps.AppListActivity;
import org.fdroid.kekstore.views.swap.SwapWorkflowActivity;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener {
    ...
    public static final String EXTRA_VIEW_UPDATES = "org.fdroid.kekstore.views.main.MainActivity.VIEW_UPDATES";
    public static final String EXTRA_VIEW_SETTINGS = "org.fdroid.kekstore.views.main.MainActivity.VIEW_SETTINGS";
    ...
    private static final String ACTION_ADD_REPO = "org.fdroid.kekstore.MainActivity.ACTION_ADD_REPO";
    ...
    private final BroadcastReceiver onUpdateableAppsChanged = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            AppUpdateStatus status = manager.get(
                    intent.getStringExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL));
