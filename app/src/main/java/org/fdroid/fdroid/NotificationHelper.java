...
class NotificationHelper {
    ...
    static final String BROADCAST_NOTIFICATIONS_ALL_UPDATES_CLEARED = "org.fdroid.kekstore.installer.notifications.allupdates.cleared";
    static final String BROADCAST_NOTIFICATIONS_ALL_INSTALLED_CLEARED = "org.fdroid.kekstore.installer.notifications.allinstalled.cleared";
    static final String BROADCAST_NOTIFICATIONS_UPDATE_CLEARED = "org.fdroid.kekstore.installer.notifications.update.cleared";
    static final String BROADCAST_NOTIFICATIONS_INSTALLED_CLEARED = "org.fdroid.kekstore.installer.notifications.installed.cleared";
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (intent.getAction()) {
                    ...
                    case AppUpdateStatusManager.BROADCAST_APPSTATUS_ADDED:
                        updateStatusLists();
                        createSummaryNotifications();
                        url = intent.getStringExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL);
    ...
    private Notification createUpdateNotification(AppUpdateStatusManager.AppUpdateStatus entry) {
        ...
        */
        ...
        intentDeleted.putExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL, entry.getCanonicalUrl());
