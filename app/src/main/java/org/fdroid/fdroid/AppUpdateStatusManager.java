...
import org.fdroid.kekstore.installer.ErrorDialogActivity;
import org.fdroid.kekstore.installer.InstallManagerService;
 ...
 * based on {@link org.fdroid.kekstore.data.Schema.InstalledAppTable} data, APKs that
 * are present in the cache, and the {@code apks-pending-install}
 * {@link SharedPreferences} instance.
 * <p>
 * As defined in {@link org.fdroid.kekstore.installer.InstallManagerService}, the
...
public final class AppUpdateStatusManager {
     ...
     */
    public static final String BROADCAST_APPSTATUS_LIST_CHANGED = "org.fdroid.kekstore.installer.appstatus.listchange";

    /**
     * Broadcast when an app begins the download/install process (either manually or via an automatic download).
     */
    public static final String BROADCAST_APPSTATUS_ADDED = "org.fdroid.kekstore.installer.appstatus.appchange.add";

    /**
     * When the {@link AppUpdateStatus#status} of an app changes or the download progress for an app advances.
     */
    public static final String BROADCAST_APPSTATUS_CHANGED = "org.fdroid.kekstore.installer.appstatus.appchange.change";
     ...
     */
    public static final String BROADCAST_APPSTATUS_REMOVED = "org.fdroid.kekstore.installer.appstatus.appchange.remove";
    ...
    private void notifyAdd(AppUpdateStatus entry) {
        if (!isBatchUpdating) {
            ...
            broadcastIntent.putExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL, entry.getCanonicalUrl());
