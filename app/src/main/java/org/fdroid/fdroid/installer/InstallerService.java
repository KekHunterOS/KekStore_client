...
public class InstallerService extends JobIntentService {
    ...
    private static final String ACTION_INSTALL = "org.fdroid.kekstore.installer.InstallerService.action.INSTALL";
    private static final String ACTION_UNINSTALL = "org.fdroid.kekstore.installer.InstallerService.action.UNINSTALL";
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        if (ACTION_INSTALL.equals(intent.getAction())) {
            ...
            Uri canonicalUri = intent.getParcelableExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL);
    ...
    public static void install(Context context, Uri localApkUri, Uri canonicalUri, Apk apk) {
        ...
        intent.putExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL, canonicalUri);
