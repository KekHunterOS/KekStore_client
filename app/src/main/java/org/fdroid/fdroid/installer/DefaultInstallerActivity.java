...
public class DefaultInstallerActivity extends FragmentActivity {
    ...
    static final String ACTION_INSTALL_PACKAGE
            = "org.fdroid.kekstore.installer.DefaultInstaller.action.INSTALL_PACKAGE";
    static final String ACTION_UNINSTALL_PACKAGE
            = "org.fdroid.kekstore.installer.DefaultInstaller.action.UNINSTALL_PACKAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ACTION_INSTALL_PACKAGE.equals(action)) {
            ...
            canonicalUri = intent.getParcelableExtra(org.fdroid.kekstore.net.Downloader.EXTRA_CANONICAL_URL);
