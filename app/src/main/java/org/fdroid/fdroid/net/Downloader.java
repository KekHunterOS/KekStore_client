...
public abstract class Downloader {
    ...
    public static final String ACTION_STARTED = "org.fdroid.kekstore.net.Downloader.action.STARTED";
    public static final String ACTION_PROGRESS = "org.fdroid.kekstore.net.Downloader.action.PROGRESS";
    public static final String ACTION_INTERRUPTED = "org.fdroid.kekstore.net.Downloader.action.INTERRUPTED";
    public static final String ACTION_CONNECTION_FAILED = "org.fdroid.kekstore.net.Downloader.action.CONNECTION_FAILED";
    public static final String ACTION_COMPLETE = "org.fdroid.kekstore.net.Downloader.action.COMPLETE";

    public static final String EXTRA_DOWNLOAD_PATH = "org.fdroid.kekstore.net.Downloader.extra.DOWNLOAD_PATH";
    public static final String EXTRA_BYTES_READ = "org.fdroid.kekstore.net.Downloader.extra.BYTES_READ";
    public static final String EXTRA_TOTAL_BYTES = "org.fdroid.kekstore.net.Downloader.extra.TOTAL_BYTES";
    public static final String EXTRA_ERROR_MESSAGE = "org.fdroid.kekstore.net.Downloader.extra.ERROR_MESSAGE";
    public static final String EXTRA_REPO_ID = "org.fdroid.kekstore.net.Downloader.extra.REPO_ID";
    public static final String EXTRA_MIRROR_URL = "org.fdroid.kekstore.net.Downloader.extra.MIRROR_URL";
    /**
     ...
     *
     * @see org.fdroid.kekstore.installer.InstallManagerService
     * @see android.content.Intent#EXTRA_ORIGINATING_URI
     */
    public static final String EXTRA_CANONICAL_URL = "org.fdroid.kekstore.net.Downloader.extra.CANONICAL_URL";
