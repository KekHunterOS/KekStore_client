...
import com.team420.kekstore.views.main.MainActivity;
...
public class NotificationHelper {
    ...
    static final String BROADCAST_NOTIFICATIONS_ALL_UPDATES_CLEARED = "com.team420.kekstore.installer.notifications.allupdates.cleared";
    static final String BROADCAST_NOTIFICATIONS_ALL_INSTALLED_CLEARED = "com.team420.kekstore.installer.notifications.allinstalled.cleared";
    static final String BROADCAST_NOTIFICATIONS_UPDATE_CLEARED = "com.team420.kekstore.installer.notifications.update.cleared";
    static final String BROADCAST_NOTIFICATIONS_INSTALLED_CLEARED = "com.team420.kekstore.installer.notifications.installed.cleared";
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (intent.getAction()) {
                    ...
                    case AppUpdateStatusManager.BROADCAST_APPSTATUS_ADDED:
                        updateStatusLists();
                        createSummaryNotifications();
                        url = intent.getStringExtra(com.team420.kekstore.net.Downloader.EXTRA_CANONICAL_URL);
    ...
    private Notification createUpdateNotification(AppUpdateStatusManager.AppUpdateStatus entry) {
        ...
        */
        ...
        intentDeleted.putExtra(com.team420.kekstore.net.Downloader.EXTRA_CANONICAL_URL, entry.getCanonicalUrl());
