...
import com.team420.kekstore.installer.ErrorDialogActivity;
import com.team420.kekstore.installer.InstallManagerService;
import com.team420.kekstore.views.AppDetailsActivity;
 ...
 * based on {@link com.team420.kekstore.data.Schema.InstalledAppTable} data, APKs that
 * are present in the cache, and the {@code apks-pending-install}
 * {@link SharedPreferences} instance.
 * <p>
 * As defined in {@link com.team420.kekstore.installer.InstallManagerService}, the
...
public final class AppUpdateStatusManager {
     ...
     */
    public static final String BROADCAST_APPSTATUS_LIST_CHANGED = "com.team420.kekstore.installer.appstatus.listchange";

    /**
     * Broadcast when an app begins the download/install process (either manually or via an automatic download).
     */
    public static final String BROADCAST_APPSTATUS_ADDED = "com.team420.kekstore.installer.appstatus.appchange.add";

    /**
     * When the {@link AppUpdateStatus#status} of an app changes or the download progress for an app advances.
     */
    public static final String BROADCAST_APPSTATUS_CHANGED = "com.team420.kekstore.installer.appstatus.appchange.change";
     ...
     */
    public static final String BROADCAST_APPSTATUS_REMOVED = "com.team420.kekstore.installer.appstatus.appchange.remove";
    ...
    private void notifyAdd(AppUpdateStatus entry) {
        if (!isBatchUpdating) {
            ...
            broadcastIntent.putExtra(com.team420.kekstore.net.Downloader.EXTRA_CANONICAL_URL, entry.getCanonicalUrl());
