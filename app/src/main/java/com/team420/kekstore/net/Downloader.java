...
import com.team420.kekstore.ProgressListener;
...
public abstract class Downloader {
    ...
    public static final String ACTION_STARTED = "com.team420.kekstore.net.Downloader.action.STARTED";
    public static final String ACTION_PROGRESS = "com.team420.kekstore.net.Downloader.action.PROGRESS";
    public static final String ACTION_INTERRUPTED = "com.team420.kekstore.net.Downloader.action.INTERRUPTED";
    public static final String ACTION_CONNECTION_FAILED = "com.team420.kekstore.net.Downloader.action.CONNECTION_FAILED";
    public static final String ACTION_COMPLETE = "com.team420.kekstore.net.Downloader.action.COMPLETE";

    public static final String EXTRA_DOWNLOAD_PATH = "com.team420.kekstore.net.Downloader.extra.DOWNLOAD_PATH";
    public static final String EXTRA_BYTES_READ = "com.team420.kekstore.net.Downloader.extra.BYTES_READ";
    public static final String EXTRA_TOTAL_BYTES = "com.team420.kekstore.net.Downloader.extra.TOTAL_BYTES";
    public static final String EXTRA_ERROR_MESSAGE = "com.team420.kekstore.net.Downloader.extra.ERROR_MESSAGE";
    public static final String EXTRA_REPO_ID = "com.team420.kekstore.net.Downloader.extra.REPO_ID";
    public static final String EXTRA_MIRROR_URL = "com.team420.kekstore.net.Downloader.extra.MIRROR_URL";
    /**
     ...
     *
     * @see com.team420.kekstore.installer.InstallManagerService
     * @see android.content.Intent#EXTRA_ORIGINATING_URI
     */
    public static final String EXTRA_CANONICAL_URL = "com.team420.kekstore.net.Downloader.extra.CANONICAL_URL";
