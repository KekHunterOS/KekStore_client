...
public class InstallerService extends JobIntentService {
    ...
    private static final String ACTION_INSTALL = "com.team420.kekstore.installer.InstallerService.action.INSTALL";
    private static final String ACTION_UNINSTALL = "com.team420.kekstore.installer.InstallerService.action.UNINSTALL";
