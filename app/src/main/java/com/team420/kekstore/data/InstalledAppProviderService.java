...
public class InstalledAppProviderService extends JobIntentService {
    ...
    private static final String ACTION_INSERT = "com.team420.kekstore.data.action.INSERT";
    private static final String ACTION_DELETE = "com.team420.kekstore.data.action.DELETE";

    private static final String EXTRA_PACKAGE_INFO = "com.team420.kekstore.data.extra.PACKAGE_INFO";
