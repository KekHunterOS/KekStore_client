...
import com.team420.kekstore.data.Schema.ApkAntiFeatureJoinTable;
import com.team420.kekstore.data.Schema.ApkTable;
import com.team420.kekstore.data.Schema.AppMetadataTable;
import com.team420.kekstore.data.Schema.AppMetadataTable.Cols;
import com.team420.kekstore.data.Schema.AppPrefsTable;
import com.team420.kekstore.data.Schema.CatJoinTable;
import com.team420.kekstore.data.Schema.CategoryTable;
import com.team420.kekstore.data.Schema.InstalledAppTable;
import com.team420.kekstore.data.Schema.PackageTable;
...
/**
 * Each app has a bunch of metadata that it associates with a package name (such as com.team420.kekstore).
...
public class AppProvider extends FDroidProvider {
     ...
     * {@link com.team420.kekstore.data.QuerySelection#add(QuerySelection)} and
     * {@link com.team420.kekstore.data.QuerySelection#add(String, String[])} methods
     * will only return the base class {@link com.team420.kekstore.data.QuerySelection}
     * which is not aware of the installed app table.
     * However, the
     * {@link com.team420.kekstore.data.AppProvider.AppQuerySelection#add(com.team420.kekstore.data.AppProvider.AppQuerySelection)}
