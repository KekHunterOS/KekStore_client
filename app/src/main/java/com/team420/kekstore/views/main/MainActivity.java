...
import com.team420.kekstore.AppUpdateStatusManager.AppUpdateStatus;
import com.team420.kekstore.BuildConfig;
import com.team420.kekstore.FDroidApp;
import com.team420.kekstore.NfcHelper;
...
import com.team420.kekstore.data.NewRepoConfig;
import com.team420.kekstore.nearby.SDCardScannerService;
import com.team420.kekstore.nearby.SwapService;
import com.team420.kekstore.nearby.SwapWorkflowActivity;
...
import com.team420.kekstore.views.ManageReposActivity;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener {
    ...
    public static final String EXTRA_VIEW_UPDATES = "com.team420.kekstore.views.main.MainActivity.VIEW_UPDATES";
    public static final String EXTRA_VIEW_NEARBY = "com.team420.kekstore.views.main.MainActivity.VIEW_NEARBY";
    public static final String EXTRA_VIEW_SETTINGS = "com.team420.kekstore.views.main.MainActivity.VIEW_SETTINGS";
    ...
    private static final String ACTION_ADD_REPO = "com.team420.kekstore.MainActivity.ACTION_ADD_REPO";
    ...
    private final BroadcastReceiver onUpdateableAppsChanged = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            AppUpdateStatus status = manager.get(
                    intent.getStringExtra(com.team420.kekstore.net.Downloader.EXTRA_CANONICAL_URL));
