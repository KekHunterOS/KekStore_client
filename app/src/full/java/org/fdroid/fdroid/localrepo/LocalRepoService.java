...
public class LocalRepoService extends IntentService {
    ...
    public static final String ACTION_CREATE = "org.fdroid.kekstore.localrepo.action.CREATE";
    public static final String EXTRA_PACKAGE_NAMES = "org.fdroid.kekstore.localrepo.extra.PACKAGE_NAMES";
